...
export type introspection_types = {
    'Boolean': unknown;
    'ConflictError': { kind: 'OBJECT'; name: 'ConflictError'; fields: { 'message': { name: 'message'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'String'; ofType: null; }; } }; }; };
    'DateTime': unknown;
    ...
    'NotFoundError': { kind: 'OBJECT'; name: 'NotFoundError'; fields: { 'message': { name: 'message'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'String'; ofType: null; }; } }; }; };
    ...
    'QueryDealResult': { kind: 'UNION'; name: 'QueryDealResult'; fields: {}; possibleTypes: 'NotFoundError' | 'QueryDealSuccess'; };
    ...
    'ValidationError': { kind: 'OBJECT'; name: 'ValidationError'; fields: { 'message': { name: 'message'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'String'; ofType: null; }; } }; }; };
};
