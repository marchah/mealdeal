...
export type introspection_types = {
    ...
    'Query': { kind: 'OBJECT'; name: 'Query'; fields: { 'deal': { name: 'deal'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'UNION'; name: 'QueryDealResult'; ofType: null; }; } }; 'deals': { name: 'deals'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Deal'; ofType: null; }; }; }; } }; 'merchantCount': { name: 'merchantCount'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; 'prefs': { name: 'prefs'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'TrackingPref'; ofType: null; }; }; }; } }; 'stats': { name: 'stats'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Stats'; ofType: null; }; } }; }; };
