...
export type introspection_types = {
    ...
    'ID': unknown;
    'Int': unknown;
    'Merchant': { kind: 'OBJECT'; name: 'Merchant'; fields: { 'createdAt': { name: 'createdAt'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'DateTime'; ofType: null; }; } }; 'id': { name: 'id'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'ID'; ofType: null; }; } }; 'name': { name: 'name'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'String'; ofType: null; }; } }; }; };
    ...
    'Query': { kind: 'OBJECT'; name: 'Query'; fields: { 'deal': { name: 'deal'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'UNION'; name: 'QueryDealResult'; ofType: null; }; } }; 'deals': { name: 'deals'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Deal'; ofType: null; }; }; }; } }; 'getCouponTypes': { name: 'getCouponTypes'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'CouponType'; ofType: null; }; }; }; } }; 'prefs': { name: 'prefs'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'TrackingPref'; ofType: null; }; }; }; } }; 'stats': { name: 'stats'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Stats'; ofType: null; }; } }; }; };
